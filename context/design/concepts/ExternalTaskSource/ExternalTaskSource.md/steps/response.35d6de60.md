---
timestamp: 'Thu Oct 23 2025 20:22:59 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251023_202259.47ef0328.md]]'
content_id: 35d6de60732f300845a1a39b792f97880922cfc3576c9af2418e13213a5759a7
---
...
a mapping from ExternalAssignmentId to // ExternalAssignmentId is an opaque identifier (e.g., String)
externalSourceAccount: ExternalSourceAccount      // The source this external assignment belongs to
internalAssignmentId: Assignment                  // The corresponding internal assignment identifier (generic param)
...
pollExternalSource (sourceAccount: ExternalSourceAccount): (rawExternalAssignments: set of { externalId: ExternalAssignmentId, details: ExternalAssignmentDetails, externalModificationTimestamp: Timestamp })
...
identifyChanges (sourceAccount: ExternalSourceAccount, rawExternalAssignments: set of { externalId: ExternalAssignmentId, details: ExternalAssignmentDetails, externalModificationTimestamp: Timestamp }): (assignmentsToProcess: set of { externalId: ExternalAssignmentId, details: ExternalAssignmentDetails, externalModificationTimestamp: Timestamp, existingInternalId: Assignment | null })
...
If `externalId` is not currently mapped in the state for `sourceAccount`, OR if its `externalModificationTimestamp` is newer than the stored `mapping[externalId].lastExternalModificationTimestamp`:
...
recordInternalSync (sourceAccount: ExternalSourceAccount, externalId: ExternalAssignmentId, internalId: Assignment, externalModificationTimestamp: Timestamp)
...
**requires** `sourceAccount` exists in the concept's state.
**effects**
The mapping for `externalId` for the given `sourceAccount` is created or updated to associate it with `internalId`.
...
getMappedInternalId (externalId: ExternalAssignmentId, sourceAccount: ExternalSourceAccount): (internalId: Assignment)
