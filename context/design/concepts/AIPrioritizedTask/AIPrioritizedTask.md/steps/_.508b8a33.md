---
timestamp: 'Thu Oct 23 2025 11:11:19 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251023_111119.24209fe9.md]]'
content_id: 508b8a3303294377bd1f71eed430b14a280661d109088c956c292cd021dce753
---
...
**effects**
The system attempts to use an LLM to infer the task's effort (in hours), importance (1-10), and difficulty (1-10) from its name and description. These attributes are validated against their specified ranges. If the LLM inference succeeds and validation passes, the task's inferred attributes are updated and the priority score is calculated by combining time urgency with weighted LLM attributes. If the LLM inference fails or validation fails, the inferred attributes are cleared and the priority score is calculated based solely on time urgency (due date and overdue status). The timestamp of the last priority calculation is recorded.
