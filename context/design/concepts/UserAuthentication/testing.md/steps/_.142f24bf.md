...
content_id: 142f24bfefaf257317fb4401cc5cffd104b5af0e8820c75751382ddff9aa02de
---
...
credentialType is an empty string
**effects** return error := "Invalid session token" if session not found, "Credential type cannot be empty" if credentialType is empty
...
**requires**
exists s in activeSessions where s.sessionToken = sessionToken AND
credentialType is not an empty string AND
let user\_found be s.user where s.sessionToken = sessionToken AND
user\_found.additionalCredentials contains key credentialType
**effects**
let user\_found be s.user where s.sessionToken = sessionToken
...
**requires**
not (exists s in activeSessions where s.sessionToken = sessionToken) OR
credentialType is an empty string OR
(exists s in activeSessions where s.sessionToken = sessionToken AND
let user\_found be s.user where s.sessionToken = sessionToken AND
not (user\_found.additionalCredentials contains key credentialType))
**effects** return error := "Invalid session token" if session not found, "Credential type cannot be empty" if credentialType is empty, "Credential type not found for this user" if credential doesn't exist
