...
content_id: 3147a3419b093b50bd233e84dd8edd4b875fd5009d9a810c2201a204b78defac
---

# file: src/concepts/TodoListConcept.ts
...
export default class TodoListConcept {
  ...
  async recreateRecurringList(
    ...
    switch (existingList.recurrenceType) {
      case "daily":
        ...
        newEndTime = addDays(existingList.endTime, 1);
        break;
      case "weekly":
        newStartTime = addWeeks(existingList.endTime, 1);
        newEndTime = addWeeks(existingList.endTime, 1);
        break;
      case "monthly":
        newStartTime = addMonths(existingList.endTime, 1);
        newEndTime = addMonths(existingList.endTime, 1);
        break;
      default:
  ...
  /**
   * _getListsForUser (user: User): (lists: set of List)
   *
  ...
  /**
   * _getListByName (user: User, name: String): (list: List)
   *
  ...
  /**
   * _getActiveListsForUser (user: User): (lists: set of List)
   *
